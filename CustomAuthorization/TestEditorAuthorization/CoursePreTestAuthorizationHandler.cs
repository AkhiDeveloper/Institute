...
{
    public class CoursePreTestRequriements
        : IAuthorizationRequirement
    {
        public CoursePreTestRequriements()
        {

        }
    }
    public class CoursePreTestAuthorizationHandler 
        : AuthorizationHandler<TestAuthorRequirements>
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IInstituteDataRepoCRUD _instituteData;

        public CoursePreTestAuthorizationHandler(
            ...
            TestAuthorRequirements requirement)
        {
            try
            {
                ...
                //Geting CoursePreTest Author
                var coursepretest = _instituteData
                    .GetCoursePreTest(testid)
                    .GetAwaiter()
                    .GetResult();
                var courseid = coursepretest.RefCourseId;
