...
{
    public class LessonPreTestRequirements
        : IAuthorizationRequirement
    {
        public LessonPreTestRequirements()
        {
        ...
        : AuthorizationHandler<TestAuthorRequirements>
    {
            ...
            TestAuthorRequirements requirement)
        {
            try
            {
                ...
                //Geting LessonPreTest Author
                var lessonpretest = _instituteData
                    .GetLessonPreTest(testid)
                    .GetAwaiter()
                    .GetResult();
                var lesson = _instituteData
                    .GetLesson(lessonpretest.RefLessonId)
                    .GetAwaiter()
                    .GetResult();
