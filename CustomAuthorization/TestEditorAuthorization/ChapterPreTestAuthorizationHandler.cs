...
{
    public class ChapterPreTestRequirements
        : IAuthorizationRequirement
    {
        public ChapterPreTestRequirements()
        {
        ...
        : AuthorizationHandler<TestAuthorRequirements>
    {
            ...
            TestAuthorRequirements requirement)
        {
            try
            {
                ...
                var chapterpretest = _instituteData
                    .GetChapterPreTest(testid)
                    .GetAwaiter()
                    .GetResult();
                var chapterid = chapterpretest.RefChapterId;
